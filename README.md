...
```sh
wget -O- https://raw.githubusercontent.com/pabumake/openwrt-kidsnetwork/0.1.3/install.sh | sh
```
...
```sh
wget -O- https://raw.githubusercontent.com/pabumake/openwrt-kidsnetwork/0.1.3/scripts/openwrt-uninstall.sh | sh
```
